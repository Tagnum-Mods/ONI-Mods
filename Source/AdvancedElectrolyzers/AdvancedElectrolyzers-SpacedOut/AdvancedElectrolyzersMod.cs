...
namespace TagnumElite.AdvancedElectrolyzers
{
    public sealed class AdvancedElectrolyzersMod : KMod.UserMod2
    {
        ...
        public class ModConfig
        {
            ...
            [Option("STRINGS.ADVANCEDELECTROLYZERS.OPTIONS.INDUSTRIAL_ELECTROLYZER")]
            [JsonProperty]
            public IndustrialElectrolyzerConfig.IEConfig advancedElectrolyzer { get; set; }

            public ModConfig()
            {
                advancedElectrolyzer = new IndustrialElectrolyzerConfig.IEConfig();
            }
        }
    ...
    public static class Db_Initialize_Patch
    {
        ...
        {
            ModUtil.AddBuildingToPlanScreen("Oxygen", IndustrialElectrolyzerConfig.ID);
            AddBuildingToTechnology("ImprovedOxygen", IndustrialElectrolyzerConfig.ID);
        }
