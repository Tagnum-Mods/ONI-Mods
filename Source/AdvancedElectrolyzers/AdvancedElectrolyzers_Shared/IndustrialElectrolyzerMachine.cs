...
namespace TagnumElite.AdvancedElectrolyzers
{
    public class IndustrialElectrolyzerMachine : StateMachineComponent<IndustrialElectrolyzerMachine.StatesInstance>
    {
        public class StatesInstance : GameStateMachine<States, StatesInstance, IndustrialElectrolyzerMachine, object>.GameInstance
        {
            ...
            {
                //statusItemEntries.Add(master.GetComponent<KSelectable>().AddStatusItem(IndustrialElectrolyzerInputStatusItem));
                statusItemEntries.Add(master.GetComponent<KSelectable>().AddStatusItem(IndustrialElectrolyzerOutputStatusItem, GameTags.Oxygen));
                statusItemEntries.Add(master.GetComponent<KSelectable>().AddStatusItem(IndustrialElectrolyzerOutputStatusItem, GameTags.Hydrogen));
            }
        ...
        protected override void OnPrefabInit()
        {
            ...
            /*if (IndustrialElectrolyzerInputStatusItem == null)
            {
                IndustrialElectrolyzerInputStatusItem = new StatusItem("INDUSTRIALELECTROLYZERINPUT", "BUILDING", string.Empty, StatusItem.IconType.Info, NotificationType.Neutral, allow_multiples: false, OverlayModes.None.ID).SetResolveStringCallback(delegate (string str, object data)
                {
            ...
            if (IndustrialElectrolyzerOutputStatusItem == null)
            {
                IndustrialElectrolyzerOutputStatusItem = new StatusItem("INDUSTRIALELECTROLYZEROUTPUT", "BUILDING", string.Empty, StatusItem.IconType.Info, NotificationType.Neutral, allow_multiples: true, OverlayModes.None.ID).SetResolveStringCallback(delegate (string str, object data)
                {
                    Tag tag = (Tag)data;
        ...
        //private static StatusItem IndustrialElectrolyzerInputStatusItem;

        private static StatusItem IndustrialElectrolyzerOutputStatusItem;
        ...
        public IndustrialElectrolyzerConfig.IEConfig Config => IndustrialElectrolyzerConfig.Config;
